...
THORDATA_HOST = os.getenv("ATTEMPT_2_PROXY_HOST")
THORDATA_PORT = os.getenv("ATTEMPT_2_PROXY_PORT")
THORDATA_USER = os.getenv("ATTEMPT_2_PROXY_USER")
THORDATA_PASS = os.getenv("ATTEMPT_2_PROXY_PASS")
