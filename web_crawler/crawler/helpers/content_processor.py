...
class ContentProcessor:
    ...
    @staticmethod
    def convert_to_markdown(html: str, url: str, only_main_content: bool = False, ignore_tags: list = None) -> str:
        """Convert HTML to clean, LLM-ready markdown (Firecrawl-style)"""
        title, clean_body, links, images, script_data = cleanup_html(html, url, only_main_content, ignore_tags=ignore_tags)
