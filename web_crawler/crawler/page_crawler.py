...
class PageCrawler:
   ...
   def process_page(
       ...
       try:
           ...
           title = seo.get("title") or seo.get("og_site_name") or "No Title"
       ...
       try:
           ...
           with sync_playwright() as p:
               ...
               try:
                   ...
                   high_sec_sites = ["meesho", "expedia", "zillow", "axs", "southwest", "delta","skyscanner"]
   ...
   def crawl_with_camoufox(
       ...
       try:
           ...
           high_sec_sites = [
               ...
               "supremenewyork.com", "wayfair.com", "zillow.com","skyscanner"
           ]
   ...
   def _handle_popups_and_overlays(self, page: Page):
       """
       Aggressively handles popups and cookie banners.
       """
       try:
           ...
           page.evaluate("""
               () => {
                   ...
                   document.querySelectorAll('*').forEach(el => {
                       ...
                       if (parseInt(style.zIndex) > 1000 && !['HEADER', 'NAV'].includes(el.tagName)) {
